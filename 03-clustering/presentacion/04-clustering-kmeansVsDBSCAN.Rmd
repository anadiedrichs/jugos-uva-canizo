...
library("GGally")
library(ggplot2)
pm <- ggpairs(dataset, mapping = aes(color = Origen), columns = colnames(dataset)[-ncol(dataset)])
pm
```
...
* Son pocas muestras (30) por lo que no nos animamos a realizar conclusiones globales
